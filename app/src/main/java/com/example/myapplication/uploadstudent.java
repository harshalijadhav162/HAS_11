...
public class uploadstudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref = firebaseDatabase.getReference().child("studentdata");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rollno = editem1.getText().toString().trim();

                String myclass = editem2.getText().toString().trim();
                String batch = edtwo.getText().toString().trim();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Task<Uri> downloadurl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                ...
                                newpost.child("rollno").setValue(rollno);

                                newpost.child("batch").setValue(batch);

                                newpost.child("myclass").setValue(myclass);
